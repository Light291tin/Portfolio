...
const Cart = () => {
  return (
    <div className="container" style={{ marginTop: '150px' }}>
      <h2 className="text-center mb-5" style={{ fontFamily: 'Playfair Display, serif' }}>Votre Panier</h2>
      <div className="text-center py-5 bg-light">
        <p className="lead">Votre panier est vide.</p>
        <Link to="/collections/all" className="btn btn-dark mt-3 text-uppercase">
...
/* Faut revoir la page complete mais on garde le style du bouton pour l'instant 
